...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .topbar { background: var(--surface); border-bottom: 1px solid var(--border); padding: .9rem 1.75rem; display: flex; align-items: center; justify-content: space-between; }
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        {{-- Historial — visible si tiene permiso HIST_VIEW --}}
        ...
        <a href="{{ route('usuarios.index') }}" class="nav-item {{ request()->routeIs('usuarios*') || request()->routeIs('cargos*') ? 'active' : '' }}">
        ...
        {{-- Atención al cliente — Admin y Recepcionista con permiso --}}
